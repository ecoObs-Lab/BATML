...
## Example application CoreMLManager
CoreMLManager allows to tag bat calls in sonagrams, save the tags in a database file and exports the tags an images for training a image recognizer. For adding sonagrams, just choose a folder with recordings, display the somnagrams based on clicking into an overview sonagram and then draw rectangles for tagging.

![BATML graphic](https://github.com/ecoObs-Lab/BATML/blob/main/images/BatCoreMLTagging.png?raw=true)
![BATML graphic](https://github.com/ecoObs-Lab/BATML/blob/main/images/BatCoreMLShowTags.png?raw=true)
